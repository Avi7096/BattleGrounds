                ...
                <form action="" method="post" id="editJobForm" name="editJobForm">
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-1">Edit Competition Details</h3>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="" class="mb-2">Title<span class="req">*</span></label>
                                    <input value="{{ $job->title }}" type="text" placeholder="Competition Title" id="title" name="title" class="form-control">
                                    <p></p>
                                </div>
                                {{-- <div class="col-md-6  mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="" class="mb-2">Genre<span class="req">*</span></label>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Time remaining</label>
                                    <input value="{{ $job->salary }}" type="text" placeholder="Time remaining" id="salary" name="salary" class="form-control">
                                </div>
