                ...
                <form action="" method="post" id="createJobForm" name="createJobForm">
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            <h3 class="fs-4 mb-1">Competition Details</h3>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label for="" class="mb-2">Title<span class="req">*</span></label>
                                    <input type="text" placeholder="Competition Title" id="title" name="title" class="form-control">
                                    <p></p>
                                </div>
                                {{-- <div class="col-md-6  mb-4">
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Time Reaminning</label>
                                    <input type="text" placeholder="Time Reaminning" id="salary" name="salary" class="form-control">
                                </div>
