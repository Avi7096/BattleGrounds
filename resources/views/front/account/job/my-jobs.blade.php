                ...
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="fs-4 mb-1">My Competitions</h3>
                            </div>
                            <div style="margin-top: -10px;">
                                <a href="{{ route("account.createJob") }}" class="btn btn-primary">Post a Competition</a>
                            </div>
                            ...
                            <table class="table ">
                                <thead class="bg-light">
                                    <tr>
                                        ...
                                        <th scope="col">Competition Created</th>
                                ...
                                <tbody class="border-0">
                                    @if ($jobs->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            ...
                                            <td>{{ $job->applications->count() }} Competitors</td>
                                            <td>
                                                @if ($job->status == 1)
