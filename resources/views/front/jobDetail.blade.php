            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> &nbsp;Back to Home</a></li>
                    </ol>
                </nav>
            </div>
        </div> 
                ...
                <div class="card shadow border-0">
                            ...
                            <div class="jobs_left d-flex align-items-center">
                                ...
                                <div class="jobs_conetent">
                                    ...
                                    <div class="links_locat d-flex align-items-center">
                                        ...
                                        <div class="location">
                                            <p> <i class="fa fa-clock-o"></i> {{ $job->salary }} Days left</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @if (Auth::check())
                                <a href="#" onclick="applyJob({{ $job->id }})" class="btn btn-primary">Compete</a>
                            @else
                                <a href="javascript:void(0);" class="btn btn-primary disabled">Login to Compete</a>
                            @endif
                    ...
                    <div class="descript_wrap white-bg">
                        <table class="table table-striped">
                            ...
                            @if ($applications->isNotEmpty())
                                ...
                                @else
                                <tr>
                                    <td colspan="3">Competitors not found</td>
                                </tr>
                            @endif
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                @if (!empty($job->salary))
                                <li>Days Remaining: <span>{{ $job->salary }}</span></li>
                                @endif

                                {{-- <li>Location: <span>{{ $job->location }}</span></li> --}}
                                <li>Game Nature: <span> {{ $job->jobType->name }}</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
function applyJob(id){
    if (confirm("Are you sure you want to apply for this competition?")) {
        $.ajax({
            url : '{{ route("applyJob") }}',
            type: 'post',
            data: {id:id},
